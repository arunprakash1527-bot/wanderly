-- ============================================
-- Wanderly Schema v2 — Safe to re-run
-- ============================================
...
drop table if exists public.trip_preferences cascade;
drop table if exists public.trip_stays cascade;
drop table if exists public.trip_travellers cascade;
...
-- Trips
create policy "Trips viewable by all" on public.trips for select using (true);
